...
func cli() *cobra.Command {
	...
	cmd.Flags().BoolVar(&warnMissingPackagesFlag, "warn-missing-packages", false, "when truee warn about missied package mappings instead of using the original package name")
